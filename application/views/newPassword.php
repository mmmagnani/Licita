...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Atas Vigentes | Administração do Sistema Log in</title>
  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="#"><b>Atas Vigentes</b><br>Administração do Sistema</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form action="<?php echo base_url(); ?>index.php/createPasswordUser" method="post">
          ...
          <div class="form-group has-feedback">
            <input type="password" class="form-control" placeholder="Confirmar Senha" name="cpassword" required />
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
          </div>
          <div class="row">
            <div class="col-xs-8">    
