...
<!--[if gt IE 8]><!--> <html class="no-js" lang="pt-br" dir="ltr"> <!--<![endif]-->
	...
	<title>BANT - Licitações Agendadas e Atas Vigentes</title>
            ...
            <div class="row-fluid">
                <div id="logo" class="span8 small">
                    <a href="http://www.bant.intraer/" title="Base Aérea de Natal">
                            <div class="span2">
                                <img src="<?php echo base_url(); ?>assets/images/DOMBANT2.png" alt="Base Aérea de Natal" />
                            </div>
                        <div class="span10">
...
<a href="http://www.bant.intraer/index.php?option=com_blankcomponent&amp;view=default&amp;Itemid=101" class="pathway">Página inicial</a> <span class="separator"> &gt; </span> <span>Licitações Agendadas e Atas Vigentes</span></div>
            </section>
        </div>
        ...
        <a href="<?php echo base_url() ?>index.php/forgotPassword">Esqueceu sua senha?</a><br>
           ...
           <div class="row-fluid">
                ...
                <div class="box-body table-responsive no-padding">
                  ...
                  <thead>
                    ...
                    <tr>
                      ...
                      <td style="max-width:150px"><?php echo $vigentes->descricao ?></td>
					  <td><?php echo $vigentes->gerset ?>
					  <td><?php echo $vigentes->ato_nomeacao ?>
                      ...
                      <a class="btn btn-sm btn-info tip-top" title="Ver Atas" href="<?php echo base_url().'index.php/verAtas/'.$vigentes->idLicitacao; ?>"><i class="fa fa-eye"></i></a></td>
                    </tr>
                    <?php
                        }
                    }
            ...
            <div class="col-xs-12">
              <div class="box">
                <div style="border-top:groove; border-top-color:#06F" class="box-header">
                    <h3 class="box-title">Pesquisar Itens das Atas Vigentes</h3>

                </div><!-- /.box-header -->
                <div class="box-body table-responsive no-padding">
                  <table id="pesquisa" class="table table-striped table-bordered">
                  <thead>
                    <tr>
                      <th>Pregão</th>
					  <th>Nº Item</th>
...
<script>
    ...
    $(document).ready(function() {
		...
		$('#pesquisa').dataTable( {
        	...
        	"ajax": {
            	"url": "<?php echo base_url().'index.php/login/getLists/'; ?>",
            	"type": "POST"
        	}
        } );
    } );
