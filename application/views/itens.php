...
<a href="http://www.bant.intraer/index.php?option=com_blankcomponent&amp;view=default&amp;Itemid=101" class="pathway">Página inicial</a> <span class="separator"> &gt; </span> <a href="<?php echo base_url(); ?>" class="pathway">Licitações Agendadas e Atas Vigentes</a><span class="separator"> &gt; </span><a href="<?php echo base_url().'index.php/verAtas/'.$forn->licitacao_id ?>">Atas</a><span class="separator"> &gt; </span><span>Itens</span></div>
            </section>
        </div>
